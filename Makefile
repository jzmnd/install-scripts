...
run: set_osx_defaults install_main install_jupyterlab install_zsh set_rc_files

.PHONY: run set_osx_defaults install_main install_jupyterlab install_zsh set_rc_files
